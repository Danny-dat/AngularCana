...
async createSuggestion(params: {
  ...
  // 1) Vorschlag dokumentieren (für Admin-Übersicht) muss "hart" sein
  ...
  // 2+3) Admin-DM nur "best effort" – darf nie die Success-Meldung killen
  try {
    ...
    // Wichtig: Keine UI-Fehlermeldung mehr – nur Debug-Log
    console.warn('[event_suggestions] saved, but admin notify failed:', err);
  }
